...
public class TeamFoundationServerScmTest {
    ...
    public void assertDefaultValueIsUsedForEmptyLocalPath() {
        TeamFoundationServerScm scm = new TeamFoundationServerScm("serverurl", "proxyserver", "projectpath", "", false, "workspace", "user", "password");
    ...
    public void assertDefaultValueIsUsedForEmptyWorkspaceName() {
        TeamFoundationServerScm scm = new TeamFoundationServerScm("serverurl", "proxyserver", "projectpath", ".", false, "", "user", "password");
    ...
    public void assertGetModuleRootReturnsWorkFolder() throws Exception {
        ...
        TeamFoundationServerScm scm = new TeamFoundationServerScm("serverurl", "proxyserver", "projectpath", "workfolder", false, "", "user", "password");
    ...
    public void assertWorkspaceNameIsAddedToEnvVars() throws Exception {
        TeamFoundationServerScm scm = new TeamFoundationServerScm("serverurl", "proxyserver", "projectpath", ".", false, "WORKSPACE_SAMPLE", "user", "password");
        AbstractBuild build = mock(AbstractBuild.class);
        AbstractProject project = mock(AbstractProject.class);
        when(build.getProject()).thenReturn(project);
    ...
    public void assertWorksfolderPathIsAddedToEnvVars() throws Exception {
        TeamFoundationServerScm scm = new TeamFoundationServerScm("serverurl", "proxyserver", "projectpath", "PATH", false, "WORKSPACE_SAMPLE", "user", "password");
    ...
    @Test public void assertProjectPathResolvesBuildVariables() {
        ...
        TeamFoundationServerScm scm = new TeamFoundationServerScm(null, null, "$/$PARAM/path", ".", false, "", "user", "password");
    ...
    @Test public void assertTfsWorkspaceIsntRemovedIfThereIsNoBuildWhenProcessWorkspaceBeforeDeletion() throws Exception {
        ...
        TeamFoundationServerScm scm = new TeamFoundationServerScm("server", null, "projectpath", ".", false, "workspace", "user", "password");
    ...
    @Test public void assertWorkspaceIsntRemoveIfThereIsNoBuildOnSpecifiedNodeAndHudsonWantsToRemoveWorkspaceOnNode() throws Exception {
        ...
        TeamFoundationServerScm scm = new TeamFoundationServerScm("server", "proxy", "projectpath", ".", false, "workspace", "user", "password");
