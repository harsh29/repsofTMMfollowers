...
public class BuildWorkspaceConfigurationRetrieverTest {
    ...
    public void assertGetLatestConfgiurationOnNode() {
        ...
        WorkspaceConfiguration configuration = new WorkspaceConfiguration("serverUrl", "proxyServer", "workspaceName", "projectPath", "workfolder");
    ...
    public void assertSaveWorkspaceConfigurationUsesSaveOnBuild() throws IOException {
        ...
        when(build.getBuiltOn()).thenReturn(node);
        when(node.getNodeName()).thenReturn("needleNode");
        when(build.getAction(WorkspaceConfiguration.class)).thenReturn(new WorkspaceConfiguration("serverUrl", "proxyServer", "workspaceName", "projectPath", "workfolder"));
